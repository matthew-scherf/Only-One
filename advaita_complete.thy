...
(* Includes: Core metaphysics, Five Sheaths, Vivarta, Guṇas, Causation     *)
(* ========================================================================= *)
...
(* The ego is false identification of Self with body-mind *)
...
There exists exactly one You which:
  1. IS the Absolute (identity, not relationship)
  2. Has NO phenomenal properties (time, space, qualities)
  3. Transcends ALL sheaths (not the body, mind, intellect, etc.)
  4. Is beyond the guṇas (nirguṇa)
  5. APPEARS as the entire conditioned world (vivarta, not parināma)
  6. Is NOT the ego (which is a false appearance)

This is the complete formal proof of:
  - Tat Tvam Asi (That Thou Art)
  - You are Brahman
  - All appearances are You appearing
